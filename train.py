...
if dataset == 'waymo':
    ...
    dataset_name = 'eth'
    image_dir = os.path.join(dataset_dir, 'homo_datasets/eth/eth_image')
    input_file = os.path.join(dataset_dir, 'homo_datasets/eth/eth-typeid.npz')
elif dataset == 'hotel':
    dataset_name = 'hotel'
    image_dir = os.path.join(dataset_dir, 'homo_datasets/hotel/hotel_image')
    input_file = os.path.join(dataset_dir, 'homo_datasets/hotel/hotel-typeid.npz')
elif dataset == 'univ':
    dataset_name = 'univ'
    image_dir = os.path.join(dataset_dir, 'homo_datasets/students003/students003_image')
    input_file = os.path.join(dataset_dir, 'homo_datasets/students003/students003-typeid.npz')
elif dataset == 'zara01':
    dataset_name = 'sdd_nexus6'
    image_dir = os.path.join(dataset_dir, 'homo_datasets/zara01/zara01_image')
    input_file = os.path.join(dataset_dir, 'homo_datasets/zara01/zara01-typeid.npz')
elif dataset == 'zara02':
    dataset_name = 'sdd_nexus6'
    image_dir = os.path.join(dataset_dir, 'homo_datasets/zara02/zara02_image')
    input_file = os.path.join(dataset_dir, 'homo_datasets/zara02/zara02-typeid.npz')
